...
/*public class Proveedor {
	...
	public Proveedor(String nombre, String descripcion, String pagina, String imagen, String correo) {
		this.nombre = nombre;
		this.descripcion = descripcion;
		this.pagina = pagina;
		this.imagen = imagen;
	...
	public String toString() {
		return "Proveedor [nombre=" + nombre + ", descripcion=" + descripcion + ", pagina=" + pagina + ", imagen="
